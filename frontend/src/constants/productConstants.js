...
export const PRODUCT_UPDATE_COUNT_REQUEST = 'PRODUCT_UPDATE_COUNT_REQUEST';
export const PRODUCT_UPDATE_COUNT_SUCCESS = 'PRODUCT_UPDATE_COUNT_SUCCESS';
export const PRODUCT_UPDATE_COUNT_FAIL = 'PRODUCT_UPDATE_COUNT_FAIL';