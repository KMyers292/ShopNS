...
export const productUpdateCountReducer = (state = {product: {}}, action) => {

    switch(action.type) {
        case PRODUCT_UPDATE_COUNT_REQUEST:
            return {
                loading: true
            }
        case PRODUCT_UPDATE_COUNT_SUCCESS:
            return {
                loading: false, 
                success: true,
                product: action.payload
            }
        case PRODUCT_UPDATE_COUNT_FAIL:
            return {
                loading: false, 
                error: action.payload
            }
